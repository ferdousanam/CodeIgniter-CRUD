...
<h2 class="bg-primary text-center" style="padding: 10px">Add Product</h2>
<div style="padding-bottom: 15px">
<?php echo form_open_multipart('product/add'); ?>
	<div class="form-group">
		<label>Product Name</label>
		<div class="text-danger"><?php echo form_error('product_name');  ?></div>
		<?php echo form_input('product_name', '', array('class'=>'form-control','id'=>'product_name', 'placeholder'=>'Enter Product Name')); ?>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<?php echo form_input('product_price', '', array('class'=>'form-control','id'=>'product_price', 'placeholder'=>'Enter Product Price')); ?>
	</div>
	<div class="form-group">
